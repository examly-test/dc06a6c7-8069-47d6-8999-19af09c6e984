...
(async () => {
  ...
  await page.goto('https://8080-fcaaecbcafccfabeafdcbbddcebecdcaceefaffcabd.ide.exam.ly');
  ...
  await page1.goto('https://8081-fcaaecbcafccfabeafdcbbddcebecdcaceefaffcabd.ide.exam.ly');
